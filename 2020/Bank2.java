...
public class Bank2 {
	...
	public void openBank() {
		String userString;
		System.out.println("Hello, welcome to Dank Bank!");
		while (true) {
			menu();
			if (choice == 4) {
				break;
	...
	public void closeAccount() {
		System.out.println("Are you sure you want to close your account? (Enter either yes, y, no, or n)");
		...
		while (true) {
			if (userString.equalsIgnoreCase("yes") || userString.equalsIgnoreCase("y")) {
				...
				numBank--;
				break;
			} else if (userString.equalsIgnoreCase("no") || userString.equalsIgnoreCase("n")) {
				System.out.println("Okay!\n");
				break;
			} else {
				System.out.println("Please only enter either yes, y, no, or n.");
			}
		}
	}
